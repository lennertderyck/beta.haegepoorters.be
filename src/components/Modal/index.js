...
const Modal = ({ open: initialState = false, onClose, disableOverlayClick, disableClose, className: cls, title, children }) => {
    ...
    return (
        <div className="fixed top-0 left-0 right-0 bottom-0 z-50 flex justify-center items-center">
            <div className="z-50 flex justify-center items-center p-8">
                <div {...className(
