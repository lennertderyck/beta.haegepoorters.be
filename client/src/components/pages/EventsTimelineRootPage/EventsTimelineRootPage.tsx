...
const EventsTimelineRootPage: FC<Props> = () => {
    ...
    const eventsToRender = useMemo(
        () =>
            eventsQuery.data?.timelineForGroups.find(
                (group: any) => group.group.abbr === selectedGroup
            )?.upcomingActivities,
        [eventsQuery.data, selectedGroup]
    );
    ...
    return (
        <div className="page">
            <div className="page__header">
                ...
                <p>
                    Activiteiten van {dayjs(EVENTS_VIEW_MIN).format("D MMMM")}{" "}
                    tot {dayjs(EVENTS_VIEW_MAX).format("D MMMM")}
                </p>
            ...
            <div className="page__content">
                ...
                {eventsQuery.isLoading && <EventItemLoader />}
                {eventsQuery.isSuccess && (
                    <Outlet context={{ events: eventsToRender }} />
                )}
            </div>
        </div>
    );
