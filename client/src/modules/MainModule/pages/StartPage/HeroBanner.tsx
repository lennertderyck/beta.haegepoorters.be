        ...
        >
            ...
            <div className="p-10 md:p-16 text-white relative z-10">
                ...
                <div className="mt-5 flex flex-col xl:flex-row xl:items-center">
                    <button className="flex items-center whitespace-nowrap text-xs text-white font-semibold uppercase tracking-widest">
                        <a href="/geschiedenis">Lees onze geschiedenis</a>
                        <i className="sc-bcXHqe dAfLZk ri-arrow-right-line -mr-1 ml-1.5"></i>
                    </button>
